...
class MainWindow(object):
    def __init__(self, master):
        ...
        self.confirm_label = Label(self.frame2)
        self.confirm_label.grid(row=2, column=0, sticky=W)
        ...
        self.input_expected_seg_confirm_button = Button(self.frame2,
                                            text=" confirm ", command=self.check_expected_seg)
        self.input_expected_seg_confirm_button.grid(row=1, column=2, sticky=W)
        # --------------- Declare entries ---------------
    ...
    def check_expected_seg(self):
        ...
        if len(self.data_pop) != self.seg_num:
            ...
            self.confirm_label.config(text=" Check input data finished. \n Please run segmentation! ")
    ...
    def run(self):
        ...
        # self.seg_zone_num = int(self.seg_zone_num_sv.get())
